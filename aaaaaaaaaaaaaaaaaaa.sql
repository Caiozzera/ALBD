...
select vendas.data_venda,
 ...
 estados.nome as estado_cliente,
...
from vendas
inner join vendedor on vendas.id_vendedor = vendedor.id
inner join clientes on  vendas.id_clientes = cliente.id
inner join cidade on cliente.id_cidade = cidades.id
inner join estados on cidades.id_estado = estado.id
inner join pais on estado.id_pais = pais.id
inner join item_venda on item_venda.id_venda = vendas.id
inner join unidade_medida on item_venda.id_unidade_medida = unidade_medida.id
